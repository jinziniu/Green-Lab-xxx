...
# Logistic Regression 实例化，增加迭代次数到 500
...
# 输出运行时间、CPU 使用率、内存使用情况、准确率、MSE 和 R² 分数
print(f"Execution Time (scikit-learnex): {execution_time:.4f} seconds")
